...
### Running the reusable workflow with OIDC authentication

This action is also available as a reusable workflow. When used as a reusable workflow, the Totango API can be stored in Azure Key Vault and is fetched using OIDC authentication. See the comments in .github/workflows/issues-to-totango-oidc.yml for setup instructions.
